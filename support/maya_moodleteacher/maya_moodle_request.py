...
from ..maya_logger.exceptions import MayaException
...
class MayaMoodleRequest(MayaBaseRequest):
  """
  Caza excepciones MoodleRequest y las relanza vía MayaExcepction
  ...
  de MayaBaseRequest. La forma más sencilla sería modificar la clase BaseRequest de moodleTeacher para
